...
const initialData = {
  ...
  comercios: [
    { id: 'co1', nombre: 'La Pizzería de Juan', imagenUrl: 'https://picsum.photos/400/300?random=1', rubroId: 'r1', subRubroId: 'sr2', provinciaId: '02', provinciaNombre: 'Ciudad Autónoma de Buenos Aires', ciudadId: 'c1', ciudadNombre: 'CABA', barrio: 'Palermo', usuarioId: 'u1', whatsapp: '5491112345678', direccion: 'Av. Corrientes 1234', googleMapsUrl: 'https://www.google.com/maps', websiteUrl: 'https://example.com', description: 'La mejor pizza de la ciudad, con ingredientes frescos y horno de barro. Más de 20 años de experiencia.', galeriaImagenes: ['https://picsum.photos/800/600?random=11', 'https://picsum.photos/800/600?random=12', 'https://picsum.photos/800/600?random=13'], publicidad: 6, vencimientoPublicidad: futureDate.toISOString(), renovacionAutomatica: true, opiniones: [
        { id: 'op1-1', usuarioId: 'pub-user-1', usuarioNombre: 'Ana G.', rating: 5, texto: '¡La mejor pizza de la ciudad! El lugar es muy acogedor y la atención de primera. Siempre volvemos.', timestamp: new Date(today.getTime() - 2 * 24 * 60 * 60 * 1000).toISOString() },
        { id: 'op1-2', usuarioId: 'pub-user-2', usuarioNombre: 'Marcos R.', rating: 4, texto: 'Muy buena pizza, aunque tardaron un poco en traerla un sábado a la noche. Recomendable de todas formas.', timestamp: new Date(today.getTime() - 1 * 24 * 60 * 60 * 1000).toISOString() },
    ]},
    { id: 'co2', nombre: 'Boutique María', imagenUrl: 'https://picsum.photos/400/300?random=2', rubroId: 'r2', subRubroId: 'sr7', provinciaId: '14', provinciaNombre: 'Córdoba', ciudadId: 'c4', ciudadNombre: 'Córdoba Capital', barrio: 'Nueva Córdoba', usuarioId: 'u2', whatsapp: '5493511234567', direccion: 'Av. Colón 500', googleMapsUrl: 'https://www.google.com/maps', websiteUrl: 'https://example.com', description: 'Ropa de diseño exclusivo para mujeres modernas. Últimas tendencias de la moda europea.', galeriaImagenes: ['https://picsum.photos/800/600?random=21'], publicidad: 5, vencimientoPublicidad: futureDate.toISOString(), renovacionAutomatica: false, opiniones: [
        { id: 'op2-1', usuarioId: 'pub-user-3', usuarioNombre: 'Lucía F.', rating: 5, texto: '¡Amo este lugar! Siempre encuentro ropa única y de excelente calidad. La dueña es un amor.', timestamp: new Date().toISOString() },
    ]},
    { id: 'co3', nombre: 'Tech Shop', imagenUrl: 'https://picsum.photos/400/300?random=3', rubroId: 'r3', subRubroId: 'sr12', provinciaId: '82', provinciaNombre: 'Santa Fe', ciudadId: 'c6', ciudadNombre: 'Rosario', barrio: 'Centro', usuarioId: 'u3', whatsapp: '5493411234567', direccion: '', googleMapsUrl: '', websiteUrl: '', description: '', publicidad: 1, renovacionAutomatica: false, opiniones: [
         { id: 'op3-1', usuarioId: 'pub-user-4', usuarioNombre: 'Pedro M.', rating: 3, timestamp: new Date().toISOString() },
    ]},
    { id: 'co4', nombre: 'Plomero 24hs', imagenUrl: 'https://picsum.photos/400/300?random=4', rubroId: 'r4', subRubroId: 'sr17', provinciaId: '06', provinciaNombre: 'Buenos Aires', ciudadId: 'c2', ciudadNombre: 'La Plata', barrio: '', usuarioId: 'u4', whatsapp: '5492211234567', direccion: '', googleMapsUrl: '', websiteUrl: '', description: 'Servicio de plomería y gasista matriculado. Urgencias las 24 horas en La Plata y alrededores.', publicidad: 2, vencimientoPublicidad: anotherFutureDate.toISOString(), renovacionAutomatica: true, opiniones: [
        { id: 'op4-1', usuarioId: 'pub-user-5', usuarioNombre: 'Jorge L.', rating: 5, texto: 'Me salvó un domingo a la madrugada con una inundación. Súper profesional y rápido.', timestamp: new Date().toISOString() },
    ]},
    { id: 'co5', nombre: 'Excursiones Mendoza', imagenUrl: 'https://picsum.photos/400/300?random=5', rubroId: 'r5', subRubroId: 'sr23', provinciaId: '50', provinciaNombre: 'Mendoza', ciudadId: 'c8', ciudadNombre: 'Mendoza Capital', barrio: '', usuarioId: 'u5', whatsapp: '5492611234567', direccion: '', googleMapsUrl: '', websiteUrl: '', description: '', galeriaImagenes: ['https://picsum.photos/800/600?random=51', 'https://picsum.photos/800/600?random=52'], publicidad: 5, vencimientoPublicidad: futureDate.toISOString(), renovacionAutomatica: true, opiniones: [
        { id: 'op5-1', usuarioId: 'pub-user-1', usuarioNombre: 'Ana G.', rating: 4, texto: 'Hicimos la excursión de alta montaña, los paisajes increíbles. El guía un genio.', timestamp: new Date().toISOString() },
    ]},
    { id: 'co6', nombre: 'Café de la Plaza', imagenUrl: 'https://picsum.photos/400/300?random=6', rubroId: 'r1', subRubroId: 'sr3', provinciaId: '14', provinciaNombre: 'Córdoba', ciudadId: 'c5', ciudadNombre: 'Villa Carlos Paz', barrio: 'Centro', usuarioId: 'u6', whatsapp: '5493541123456', direccion: '', googleMapsUrl: '', websiteUrl: 'https://example.com', description: 'Un lugar acogedor para disfrutar de café de especialidad y pastelería casera frente a la plaza principal.', publicidad: 3, vencimientoPublicidad: anotherFutureDate.toISOString(), renovacionAutomatica: false, opiniones: [
        { id: 'op6-1', usuarioId: 'pub-user-2', usuarioNombre: 'Marcos R.', rating: 5, texto: 'El mejor café que probé en Carlos Paz.', timestamp: new Date().toISOString() },
        { id: 'op6-2', usuarioId: 'pub-user-3', usuarioNombre: 'Lucía F.', rating: 5, texto: 'La torta de chocolate es un 10!', timestamp: new Date().toISOString() },
    ]},
    { id: 'co7', nombre: 'Ropa Deportiva SF', imagenUrl: 'https://picsum.photos/400/300?random=7', rubroId: 'r2', subRubroId: 'sr8', provinciaId: '82', provinciaNombre: 'Santa Fe', ciudadId: 'c7', ciudadNombre: 'Santa Fe Capital', barrio: '', usuarioId: 'u1', whatsapp: '5493421234567', direccion: '', googleMapsUrl: '', websiteUrl: '', description: '', publicidad: 4, vencimientoPublicidad: futureDate.toISOString(), renovacionAutomatica: true, opiniones: [] },
  ],
  banners: [
